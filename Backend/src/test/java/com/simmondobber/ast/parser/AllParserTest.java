...
public class AllParserTest {
    ...
    public void point_class_parse_test() {
        //Given
        String stringToParse = "package com.simmondobber.ast.parser.integrationTests.exampleClass;\n" +
                "\n" +
                ...
                "    }\n" +
                "}\n$";
        String correctlyParsedString = "package com.simmondobber.ast.parser.integrationTests.exampleClass;\n" +
                "\n" +
                "import lombok.Getter;\n" +
                "\n" +
                "@Getter\n" +
                ...
                "    }\n" +
                "}\n";
        FileParser parser = new FileParser(new Pointer(stringToParse));

        //When
        File parsedFile = parser.parse();
    ...
    public void pointer_class_parse_test() {
        //Given
        String stringToParse = "package com.simmondobber.ast.parser.utils;\n" +
                "\n" +
                ...
                "    }\n" +
                "}\n$";
        String correctlyParsedString = "package com.simmondobber.ast.parser.utils;\n" +
                "\n" +
                "import java.util.Map;\n" +
                "\n" +
                "public class Pointer {\n" +
