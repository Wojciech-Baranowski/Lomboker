...
public class GetterFactory {
    ...
    private String createGetterHead(Field field) {
        String indentation = createIndentation(field.getNesting());
    ...
    private String createGetterBody(Field field, boolean thisPrefix) {
        String indentation = createIndentation(field.getNesting() + 1);
    ...
    private String createIndentation(int nesting) {
